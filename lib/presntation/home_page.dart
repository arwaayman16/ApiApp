...
import 'package:cats_api/presntation/cat_page.dart';
            ...
            child: SizedBox(
              ...
              child: ListView(
                children: [
                  ...
                  ElevatedButton(
                      onPressed: () async {
                        context.read<CatsBloc>().add(getCatEvent());
                        Navigator.push(
                            context,
                            MaterialPageRoute(
                    ...
                    child: Padding(
                      ...
                      child: TextField(
                        ...
                        decoration: InputDecoration(
                            ...
                            getMoreCatsEvent(catsCount:int.parse(text.text)));

                                  Navigator.push(
                                      context,
                                      MaterialPageRoute(
                                        builder: (context) => MoreCatsPage(
